...
const brands = [
  { name: 'Star Hospitals', src: '/images/vva.png' },
  { name: 'LuLu Mall', src: '/images/immm.png' },
  { name: 'Cenco Malls', src: '/images/logo.png' },
  { name: 'Walesia', src: '/images/walesia.png' },
  { name: 'Sunrise Hospital', src: '/images/us logo.png' },
];
