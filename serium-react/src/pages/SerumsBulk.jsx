...
const products = [
  {
    ...
    tagline: 'Ideal for luxury retail and premium spa gifting.',
    variants: ['15ML Retail Pack', '15ML Signature Bottle', 'Bulk Tester Packs'],
  ...
  },
  {
    ...
    variants: ['15ML Luxury Bottle', 'Limited Edition Sleeve Pack', 'Premium Event Gift Set'],
  ...
  },
  {
    ...
    tagline: 'Cool marine freshness ideal for hotels and summer gifting kits.',
    variants: ['15ML Intro Size', '15ML Full Size', 'Bulk Fill Option'],
  ...
  },
  {
    ...
    name: 'Fruity Exotica',
    tagline: 'Lively tropical profile perfect for youth retail channels.',
    variants: ['15ML Counter Display', '15ML Signature Pack', 'Festival Combo Pack'],
  ...
  },
  {
    ...
    cat: 'Fresh Collection',
    name: 'Aqua Aroma',
    tagline: 'Clean aquatic profile for hotel amenities and corporate contracts.',
    variants: ['15ML Bulk Pack', '15ML Retail Unit', 'Spout Pouch Fill'],
    ...
    <Layout>
      ...
      <section id="serum-hero" className="relative w-full min-h-[95vh] flex items-center overflow-hidden bg-[#1a1610]">
        <div className="absolute inset-0 z-0 opacity-40">
          <SafeImage src="images/Gemini_Generated_Image_c7stt5c7stt5c7st.webp" alt="Serium Hero" className="w-full h-full object-cover object-center parallax-img" loading="eager" />
            ...
            <div className="relative animate-float">
              <div className="w-52 h-52 rounded-full p-[3px] shadow-[0_0_50px_rgba(212,168,66,0.2)]"
                ...
                <div className="w-full h-full rounded-full overflow-hidden"
                  ...
                  <img src="/images/serum_floating.png" alt="ARUOMA Serum"
        ...
        <div className="max-w-screen-xl mx-auto relative z-10 px-8 w-full">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6 mt-14 reveal-up" style={{ animationDelay: '0.4s' }}>
              ...
              <div className="flex items-center gap-6 pl-8 border-l border-white/10 uppercase tracking-[0.4em] text-[8px] text-white/40">
                ...
                <div>
                  <span className="block text-gold-400 text-lg font-serif tracking-normal">IFRA</span>
                  Safe
                </div>
              </div>
            </div>
      ...
      {/* Products Grid */}
      <section id="serum-catalogue" className="py-32 px-8 relative overflow-hidden bg-[#F9F9F4]">
        ...
        <div className="max-w-screen-xl mx-auto relative z-10">
          <div className="text-center mb-24 reveal-up">
            <h2 className="font-serif text-5xl font-light text-[#1a1610] uppercase tracking-widest">Serum <span className="italic text-gold-400">Portfolio</span></h2>
              ...
              <article key={i} className="product-card reveal-up group bg-white border border-black/5 hover:border-gold-400/20 transition-all duration-700 shadow-sm hover:shadow-2xl rounded-px" style={{ animationDelay: p.delay }}>
                ...
                <div className="p-10">
                  ...
                  <a className="block w-full text-center py-5 bg-[#1a1610] text-white text-[10px] tracking-[0.5em] uppercase font-black hover:bg-gold-400 hover:text-black transition-all duration-500 rounded-px shadow-lg hover:shadow-gold-900/20"
                    ...
                    href={`https://wa.me/8302607949?text=${p.waText}`}>Request Quote</a>
                </div>
              </article>
            ))}
          </div>
      ...
      {/* Why Choose Aruoma? - Ultra Premium Redesign */}
          ...
          <div className="flex flex-col lg:flex-row bg-[#1a1610] rounded-[30px] shadow-[0_40px_100px_rgba(40,30,20,0.15)] border border-gold-400/20 overflow-hidden relative">
            ...
            <div className="flex-1 p-12 md:p-20 relative z-10 flex flex-col justify-center">
              ...
              <div className="space-y-12 relative">
                ...
                {[
                  { title: 'IFRA Certified', desc: 'Precision-engineered formulations adhering to the strictest global safety protocols for luxury diffusion.' },
      ...
      {/* CTA */}
      <section className="py-40 px-8 overflow-hidden bg-[#1a1610] text-center border-t border-white/5 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10 reveal-up">
          ...
          <h2 className="font-serif font-light text-5xl md:text-8xl text-white leading-tight mb-14"> Ready to Elevate Your <br /><span className="gold-shimmer-text italic">Brand Narrative?</span> </h2>
          <div className="flex flex-col items-center gap-10">
            <a href="https://wa.me/8302607949?text=Hello%20I%20am%20interested%20in%20bulk%20orders%20for%20ARUOMA%20SERUMS"
              target="_blank" rel="noopener noreferrer" className="btn-gold px-16 py-6 text-[11px] font-black group">
