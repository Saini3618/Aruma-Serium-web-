    ...
    <Layout>
      ...
      <section className="py-20 sm:py-40 px-5 sm:px-8 overflow-hidden bg-[#1a1610] text-center border-t border-white/5 relative">
        ...
        <div className="max-w-4xl mx-auto relative z-10 reveal-up">
          ...
          <h2 className="font-serif font-light text-4xl sm:text-5xl md:text-8xl text-white leading-tight mb-8 sm:mb-14"> Ready to Elevate Your <br /><span className="gold-shimmer-text italic">Brand Narrative?</span> </h2>
          <div className="flex flex-col items-center gap-10">
            <a href="https://wa.me/8302607949?text=Hello%20I%20am%20interested%20in%20bulk%20orders%20for%20AROMA%20OILS"
