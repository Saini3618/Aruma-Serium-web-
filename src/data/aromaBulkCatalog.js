...
const ENTRIES = [
  { name: 'Fruity Exotica', cat: '', tagline: 'Crystalline water notes and cool mint — Parisian aqua signature in a 1 litre premium pour for large-scale diffusion.' },
  ...
  { name: 'White Oudh Aroma', cat: 'Oriental Collection', tagline: 'Refined pale oudh woods — luminous smoke, soft amber resin, and modern oriental polish.' },
  { name: 'Aqua Aroma', cat: '', tagline: 'Let desire linger in the air — cool water, blue florals, and sheer musk in a 1 litre Parisian blend.' },
  ...
  { name: 'Pumpkin Spice Aroma', cat: 'Signature Collection', tagline: 'Let desire linger in the air — warm pumpkin, baking spice, and autumn comfort in a premium poured oil.' },
  ...
  { name: 'Rose Saffron Aroma', cat: 'Accent Collection', tagline: 'Let desire linger in the air — damask rose threads with golden saffron and warm resinous depth.' },
  ...
  { name: 'Dark Amber & Charged Birch Aroma', cat: 'Oriental Collection', tagline: 'Let desire linger in the air — smoky birch, molten amber, and midnight woods in a luxury oil.' },
  ...
  { name: 'Cedar & Balsam Aroma', cat: 'Botanical Collection', tagline: 'Let desire linger in the air — frosted cedar, Canadian balsam, and evergreen cabin warmth.' },
  ...
  { name: 'Apple Cinnamon Aroma', cat: 'Exotic Collection', tagline: 'Let desire linger in the air — oven-warm apple, Ceylon cinnamon, and cozy gourmand glow.' },
  ...
  { name: 'Lavender Aromatic Aroma', cat: 'Floral Collection', tagline: 'Pure and calming aromatic oil — high-altitude lavender for sleep, spa, and serene retail.' },
  { name: 'Fresh Linen Aroma', cat: 'Fresh Collection', tagline: 'Pure and calming aromatic ambience — sun-dried cotton, soft powder, and crisp clean sheets.' },
  ...
  { name: 'WoodRize Aroma', cat: 'Botanical Collection', tagline: 'Crackling wood-inspired warmth — embered logs, smoked vetiver, and forest at dusk.' },
  ...
  { name: 'Vanilla Aroma', cat: 'Exotic Collection', tagline: 'Creamy Madagascar vanilla bean — gourmand glow with a soft wax pool and long throw.' },
