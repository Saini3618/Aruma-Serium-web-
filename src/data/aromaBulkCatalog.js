...
const ENTRIES = [
  ...
  { name: 'Ocean Breeze', tagline: 'Deep marine breeze and salt-kissed air — bold ocean identity crafted for statement lobbies and retail displays.' },
  ...
  { name: 'AAA Fawak', tagline: 'Let desire linger in the air — cool water, blue florals, and sheer musk in a 1 litre Parisian blend.' },
  ...
  { name: 'Rose Oil', tagline: 'Immerse in the luxurious essence of roses — velvet petals, soft honey, and fairy-tale romance.' },
  { name: 'Rose Saffron', tagline: 'Let desire linger in the air — damask rose threads with golden saffron and warm resinous depth.' },
  { name: 'Baccarat AG', tagline: 'High-jewellery amber florals — radiant saffron, jasmine, and cedarwood for a red-carpet ambience.' },
  ...
  { name: 'Spicy Mountain Aroma', tagline: 'Let desire linger in the air — alpine wind, crisp pine, and a kick of peppered spice.' },
  { name: 'Talisman Oudh', tagline: 'Mystical agarwood talisman — rare oudh, smoked incense, and gold resin for signature spaces.' },
  ...
  { name: 'Mango Guava', tagline: 'Let desire linger in the air — sunlit citrus grove, leafy greens, and sparkling peel.' },
  { name: 'Lemongrass Oil', tagline: 'Let desire linger in the air — night-blooming jasmine layered over zesty lemongrass for balance.' },
  { name: 'Ylang Ylang Oil', tagline: 'Let desire linger in the air — airy blue florals, cool musk, and a clean couture diffusion profile.' },
  { name: 'Golden Breeze', tagline: 'Let desire linger in the air — sharp woods, metallic sage, and modern masculine-luxe edge.' },
  { name: 'Lavender Oil', tagline: 'Pure and calming aromatic oil — high-altitude lavender for sleep, spa, and serene retail.' },
  ...
  { name: 'Chamomile Aroma', tagline: 'Pure and calming aromatic oil — Roman chamomile, hay, and honeyed herbal rest.' },
  { name: 'Reserve Blend Aroma', tagline: 'House reserve Parisian blend — versatile 1 litre diffusion oil for bespoke hospitality programs.' },
  ...
  { name: 'Peach Aroma', tagline: 'Let desire linger in the air — coastal sea salt, Mexican lime, and breezy driftwood.' },
  ...
  { name: 'Pineapple', tagline: 'Let desire linger in the air — Sweet pineapple, hint of coconut, and tropical zest' },
  { name: 'Floral Fresh Aroma', tagline: 'Aroma strong enough to steal a kiss — premium botanical ambience oil, collection no. 1, in a full litre pour.' },
  { name: 'Aqua Aroma', tagline: 'Cool water signature — crystalline aqua accord scaled for bulk diffusers and retail refill.' },
