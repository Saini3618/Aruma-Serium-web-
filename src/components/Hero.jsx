    ...
    <section id="hero" className="relative w-full min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0"
          style={{ background: 'linear-gradient(100deg, rgba(10,6,2,0.96) 0%, rgba(18,11,5,0.78) 35%, rgba(24,15,8,0.25) 75%, transparent 100%)' }}>
        </div>
      ...
      {/* Hero content */}
      <div className="relative z-10 w-full max-w-screen-2xl mx-auto px-5 sm:px-12 lg:px-20 pt-28 pb-20">

        {/* Eyebrow - Centered */}
        <div className="flex justify-center w-full mb-12 sm:mb-20 opacity-0 animate-fade-in"
          style={{ animationDelay: '0.5s', animationFillMode: 'forwards' }}>
          <div className="flex items-center gap-4">
            <div className="h-px w-8 sm:w-16 bg-gold-400"></div>
            <p className="text-[9px] sm:text-[10px] tracking-[0.6em] uppercase text-gold-400 font-medium text-center">{heroContent.eyebrow}</p>
            <div className="h-px w-8 sm:w-16 bg-gold-400"></div>
          </div>
        </div>
        ...
        <div className="max-w-2xl xl:max-w-3xl">
          <h1 className="font-serif font-light leading-none opacity-0 animate-fade-up"
            ...
            <span className="text-white block text-[0.62em] tracking-[0.08em] font-extralight mb-2">{heroContent.heading.line3}</span>
            {heroContent.heading.line4 && (
              <span className="text-gold-400 block text-[0.62em] tracking-[0.08em] font-extralight">{heroContent.heading.line4}</span>
            )}
          </h1>
