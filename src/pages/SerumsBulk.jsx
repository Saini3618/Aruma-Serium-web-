...
export default function OilsBulk() {
  useEffect(() => {
    document.title = 'Bulk Fragrance Oils | Amor Exotic';

    /* ========== PARALLAX HERO ========== */
    const heroImg = document.querySelector('.parallax-img');
    const heroSection = document.getElementById('oil-hero');
    ...
    /* ========== FLOATING PARTICLES ========== */
    const hero = document.getElementById('oil-hero');
    if (hero) {
      for (let i = 0; i < 15; i++) {
  ...
  return (
    <Layout>
        ...
        <div className="max-w-screen-xl mx-auto relative z-10 px-5 sm:px-8 w-full">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-6 mt-14 reveal-up" style={{ animationDelay: '0.4s' }}>
              <a href="#oil-catalogue" className="btn-gold group flex items-center gap-3">
      ...
      {/* Products Grid */}
      <section id="oil-catalogue" className="py-16 sm:py-32 px-5 sm:px-8 relative overflow-hidden bg-[#F9F9F4]">
