...
export default function AboutUs() {
  useEffect(() => {
    document.title = 'About Us | Amor Exotic';
    ...
    <Layout>
      ...
      <section className="py-40 bg-[#f4f0e6] relative overflow-hidden text-center">
         <div className="max-w-3xl mx-auto px-6 relative z-10 about-reveal">
            ...
            {/* Social Media Icons */}
            <div className="flex items-center justify-center gap-8 mt-16 pt-12 border-t border-[#1a1610]/10">
              <p className="text-[11px] tracking-[0.3em] uppercase font-bold text-[#1a1610]/60">Follow Us</p>
              <a 
              ...
              >
                <svg className="w-6 h-6 text-[#1a1610]/70 group-hover:text-gold-600 transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
